...
kDataPath <- file.path("~/src/boston/src/research/product/us/20210720_introductory_page_v2_us_test","data")
...
with base as (
  ...
  where country = 'US'
    and se_property ilike '%introductory_page_v2_us%'
...
save(test_data,
     file = file.path(kDataPath,"intro_page_data.RData"))
