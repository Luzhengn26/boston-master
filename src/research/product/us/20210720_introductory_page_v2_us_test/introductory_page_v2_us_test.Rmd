---
title: "introductory_page_v2_us test results"
author: "Dani Mermelstein"
date: "2021-07-20"
region: "US"
link: 
tags: "ab test, split test, signup, new screen, acquire,"
...
# load the data
load(paste0("data/intro_page_data.RData"))
...
# get outcome vectors
control <- as.integer(bayes_data[variant=='introductory_page_v2_us_control',]$outcome)
test <- as.integer(bayes_data[variant=='introductory_page_v2_us',]$outcome)
