...
where u.tnc_country_group in ('DEU')
...
currently_elig_users as (
    ...
    user_id
    from eligible_txns 
    where amount_cents_eur between 50 and 500
...
select 
    ...
    count(distinct case when amount_cents_eur between 50 and 500 then user_id end) as n_txn_eligible_users,
	count(distinct case when amount_cents_eur >= 40 and amount_cents_eur <= 500 then user_id end) as n_40_500_users,
    count(distinct case when amount_cents_eur >= 30 and amount_cents_eur <= 500 then user_id end) as n_30_500_users,
    count(distinct case when amount_cents_eur >= 20 and amount_cents_eur <= 500 then user_id end) as n_20_500_users,
    count(distinct case when amount_cents_eur >= 10 and amount_cents_eur <= 500 then user_id end) as n_10_500_users,
    count(distinct case when amount_cents_eur >= 50 and amount_cents_eur <= 600 then user_id end) as n_50_600_users,
    count(distinct case when amount_cents_eur >= 50 and amount_cents_eur <= 700 then user_id end) as n_50_700_users,
    count(distinct case when amount_cents_eur >= 50 and amount_cents_eur <= 800 then user_id end) as n_50_800_users,
    count(distinct case when amount_cents_eur >= 50 and amount_cents_eur <= 900 then user_id end) as n_50_900_users,
    count(distinct case when amount_cents_eur >= 50 and amount_cents_eur <= 1000 then user_id end) as n_50_1000_users
